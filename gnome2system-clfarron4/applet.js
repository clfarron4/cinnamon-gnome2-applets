...
let icon = new St.Icon({icon_name: "gnome-settings-themes", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings themes");
			});

		//Appearance           

let icon = new St.Icon({icon_name: "applets", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.computerItem = new MyPopupMenuItem(icon, _("Applets"));
			
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings applets");
			});

		//Background

let icon = new St.Icon({icon_name: "background", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.computerItem = new MyPopupMenuItem(icon, _("Background"));
			
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings backgrounds");
			}); 
...
let icon = new St.Icon({icon_name: "display", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings display");
			});
...
let icon = new St.Icon({icon_name: "key_bindings", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
     ...
     let icon = new St.Icon({icon_name: "keyboard", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings keyboard");
			});
...
/*		//Lang Support
	  ...
	  let icon = new St.Icon({icon_name: "edit-select-all", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.computerItem = new MyPopupMenuItem(icon, _("Menu Editor"));
			
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-menu-editor");
			});
	  ...
	  let icon = new St.Icon({icon_name: "mouse", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings mouse");
			});
	  ...
	  let icon = new St.Icon({icon_name: "network-wireless", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings network");
			});

		//Kb layout

	  let icon = new St.Icon({icon_name: "gnome-character-map", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.computerItem = new MyPopupMenuItem(icon, _("Regional Settings"));
			
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings region");
			});

		//Volume

	let icon = new St.Icon({icon_name: "screensaver", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.computerItem = new MyPopupMenuItem(icon, _("Screensaver"));
			
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings screensaver");
			});

		//Volume

	let icon = new St.Icon({icon_name: "volume-knob", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.computerItem = new MyPopupMenuItem(icon, _("Sound Settings"));
			
			this.preferencesItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings sound");
			});
...
let icon = new St.Icon({icon_name: "harddrive", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.administrationItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("gksu gparted");
			});
...
let icon = new St.Icon({icon_name: "gnome-nettool", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.administrationItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("mate-nettool");
			});
...
let icon = new St.Icon({icon_name: "preferences-other-symbolic", icon_size: ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.computerItem = new MyPopupMenuItem(icon, _("Startup Applications"));
			
			this.administrationItem.menu.addMenuItem(this.computerItem);
			this.computerItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-session-properties");
			});
...
// Separator
    ...
    let icon = new St.Icon({icon_name: "gtk-execute", icon_size: MAIN_ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			this.filesystemItem = new MyPopupMenuItem(icon, _("Cinnamon Settings"));
    ...
    let icon = new St.Icon({icon_name: "help-contents", icon_size: MAIN_ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
		...
		let icon = new St.Icon({icon_name: "info", icon_size: MAIN_ICON_SIZE, icon_type: St.IconType.FULLCOLOR});
			...
			this.menu.addMenuItem(this.filesystemItem);
			this.filesystemItem.connect('activate', function(actor, event) {
                Main.Util.spawnCommandLine("cinnamon-settings info");
			});
